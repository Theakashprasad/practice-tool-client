...
import Invitation from '../pages/Apps/Invitation';
import AIChatbot from '../pages/AIChatbot';
import Calendar from '../pages/Calendar';
import ChatWithAI from '../pages/Apps/ChatWithAI';
import ClientList from '../pages/ClientList';
import Assistant from '../pages/Assistant';
import InviteUser from '../pages/Apps/InviteUser';
import Practice8 from '../pages/Apps/Practice8';
import ClientGroup from '../pages/Apps/ClientGroup';
import ClientEntity from '../pages/Apps/ClientEntity';
import ClientDatabase from '../pages/Apps/ClientDatabase';
import ClientGroupView from '../pages/Apps/ClientGroupView';
import ClientEntityView from '../pages/Apps/ClientEntityView';
import AddClientGroup from '../pages/Apps/AddClientGroup';
import AddClientEntity from '../pages/Apps/AddClientEntity';
import Industry from '../pages/Apps/Industry';
import AddIndustry from '../pages/Apps/AddIndustry';
import ServiceTypes from '../pages/Apps/ServiceTypes';
import ServiceTypeForm from '../pages/Apps/ServiceTypeForm';
import ServicesSubscribed from '../pages/Apps/ServicesSubscribed';
import AddServiceSubscribed from '../pages/Apps/AddServiceSubscribed';
import EditServiceSubscribed from '../pages/Apps/EditServiceSubscribed';
import StaffChat from '../pages/Apps/StaffChat';
import NewLinkTypes from '../pages/Apps/NewLinkTypes';
import AddLinkType from '../pages/Apps/AddLinkType';
import LinkTypeView from '../pages/Apps/LinkTypeView';
import Contacts from '../pages/Apps/Contacts';
import AddContact from '../pages/Apps/AddContact';
import ServiceTypeView from '../pages/Apps/ServiceTypeView';
import IndustryView from '../pages/Apps/IndustryView';
import Users from '../pages/Apps/users';
import UserView from '../pages/Apps/UserView';
import AddPractice from '../pages/Apps/AddPractice';
...
const ClientManagement = lazy(() => import('../pages/Apps/ClientManagement'));
const AdminManagement = lazy(() => import('../pages/Apps/AdminManagement'));
const MyProfile = lazy(() => import('../pages/Profile/MyProfile'));
const Practice = lazy(() => import('../pages/Apps/Practice'));
const PracticeDetails = lazy(() => import('../pages/Apps/PracticeDetails'));
const RagRetrieval = lazy(() => import('../pages/Apps/RagRetrieval'));
const ToolsManagement = lazy(() => import('../pages/Apps/ToolsManagement'));
const AddTool = lazy(() => import('../pages/Apps/Tools/AddTool'));
const ToolView = lazy(() => import('../pages/Apps/Tools/ToolView'));
...
const routes = [
    ...
    {
        path: '/apps/rag-retrieval',
        element: <RagRetrieval />,
    },
    {
        path: '/apps/tools-management',
        element: <ToolsManagement />,
    },
    {
        path: '/apps/tools-management/add',
        element: <AddTool />,
    },
    {
        path: '/apps/tools-management/:id',
        element: <ToolView />,
    },
    {
        path: '/apps/staff/:id',
    ...
    {
        path: '/apps/client-group',
        element: <ClientGroup />,
    },
    {
        path: '/apps/client-entity',
        element: <ClientEntity />,
    },
    {
        path: '/apps/industry',
        element: <Industry />,
    ...
    {
        path: '/apps/industry/add',
        element: <AddIndustry />,
    },
    {
        path: '/apps/industry/edit/:id',
        element: <AddIndustry />,
    },
    {
        path: '/apps/service-types',
        element: <ServiceTypes />,
    },
    {
        path: '/apps/service-types/add',
        element: <ServiceTypeForm />,
    },
    {
        path: '/apps/service-types/:id',
        element: <ServiceTypeForm />,
    },
    {
        path: '/apps/services-subscribed',
        element: <ServicesSubscribed />,
    },
    {
        path: '/apps/services-subscribed/add',
        element: <AddServiceSubscribed />,
    },
    {
        path: '/apps/services-subscribed/edit/:id',
        element: <EditServiceSubscribed />,
    },
    {
        path: '/apps/new-link-types',
        element: <NewLinkTypes />,
    },
    {
        path: '/apps/new-link-types/add',
        element: <AddLinkType />,
    },
    {
        path: '/apps/new-link-types/:id',
        element: <LinkTypeView />,
    },
    {
    ...
    {
        path: '/apps/client-database/add-group',
        element: <AddClientGroup />,
    },
    {
        path: '/apps/client-database/add-entity',
        element: <AddClientEntity />,
    },
    {
        path: '/apps/client-group/:id',
        element: <ClientGroupView />,
    },
    {
        path: '/apps/client-entity/:id',
        element: <ClientEntityView />,
    },
    {
        path: '/apps/service-types/:id',
